Feature: Transaction processing
  ...
  Scenario Outline: The user should not be allowed to send money to himself
    ...
    Examples:
      ...
      | jaime   | 2022053111472379        | 2022053112010811          | test payment | 181.57.222.58 | 400        | message                   | must be a number with a 16 length                          |
      ...
      | 500     | federico                | 2022053112010811          | test payment | 181.57.222.58 | 400        | message                   | must be a number with a 16 length                          |
      ...
      | 500     | 2022053111472379        | alejandro                 | test payment | 181.57.222.58 | 400        | message                   | must be a number with a 16 length                          |
